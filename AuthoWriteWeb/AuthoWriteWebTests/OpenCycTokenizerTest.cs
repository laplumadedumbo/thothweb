...
namespace AuthoWriteWebTests
{
    ...
    /// <summary>
    ///This is a test class for OpenCycTokenizerTest and is intended
    ///to contain all OpenCycTokenizerTest Unit Tests
    ///</summary>
    [TestClass()]
    public class OpenCycTokenizerTest
    {
        ...
        {
            OpenCycTokenizer target = new OpenCycTokenizer(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for OpenCycTokenizer Constructor
        ///</summary>
        [TestMethod()]
        [HostType("ASP.NET")]
        [AspNetDevelopmentServerHost("C:\\Users\\Lenworth\\Documents\\Visual Studio 2008\\Projects\\AuthoWriteWeb\\AuthoWriteWeb", "/")]
        [UrlToTest("http://localhost:53459/")]
        public void OpenCycTokenizerConstructorTest()
        {
            OpenCycTokenizer target = new OpenCycTokenizer();
